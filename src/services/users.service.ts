...
class Users {
    collection: import("mongoose").Model<import("../interfaces/user.interfaces").default, {}, {}, {}, import("mongoose").Document<unknown, {}, import("../interfaces/user.interfaces").default> & Omit<import("../interfaces/user.interfaces").default & { _id: import("mongoose").Types.ObjectId; }, never>, import("mongoose").Schema<import("../interfaces/user.interfaces").default, import("mongoose").Model<import("../interfaces/user.interfaces").default, any, any, any, import("mongoose").Document<unknown, any, import("../interfaces/user.interfaces").default> & Omit<import("../interfaces/user.interfaces").default & { _id: import("mongoose").Types.ObjectId; }, never>, any>, {}, {}, {}, {}, import("mongoose").DefaultSchemaOptions, import("../interfaces/user.interfaces").default, import("mongoose").Document<unknown, {}, import("mongoose").FlatRecord<import("../interfaces/user.interfaces").default>> & Omit<import("mongoose").FlatRecord<import("../interfaces/user.interfaces").default> & { _id: import("mongoose").Types.ObjectId; }, never>>>;
    constructor() {
